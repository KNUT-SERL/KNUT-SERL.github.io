...
MEMBER({
  ...
  slug: "lee-junho",              // 사진 이름 → images/members/lee-junho.jpg (없으면 .png, 그것도 없으면 이니셜)
  name: "Junho Lee",              // 영문 이름 — 카드 제목
  kor: "이준호",                  // 한글 이름 — 이름 옆 괄호 안에 표시
  role: "M.S. Student",           // 과정 표기
  email: "wnsgh1916@naver.com",   // 이메일 — 비우면("") 카드에 표시되지 않음
  interests: "Soft robotics, soft grippers", // 카드에 늘 보이는 연구 키워드 한 줄

  /* 아래 4개는 카드를 클릭했을 때 펼쳐지는 상세 패널 내용입니다.
     네 개를 모두 비워 두면 패널 자체가 만들어지지 않습니다. */
  bio: "Bioinspired suction interfaces for strain-guided, adaptive object handling.", // Research — 대표 연구 설명 1~2문장
