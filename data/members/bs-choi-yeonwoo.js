...
MEMBER({
  ...
  slug: "choi-yeonwoo",           // 사진 이름 → images/members/choi-yeonwoo.jpg (없으면 .png, 그것도 없으면 이니셜)
  name: "Yeonwoo Choi",           // 영문 이름 — 카드 제목
  kor: "최연우",                  // 한글 이름 — 이름 옆 괄호 안에 표시
  role: "Undergraduate Researcher", // 과정 표기
  email: "choiyeonwoo12@naver.com", // 이메일 — 비우면("") 카드에 표시되지 않음
  interests: "Wearable sensing systems", // 카드에 늘 보이는 연구 키워드 한 줄
