...
MEMBER({
  ...
  slug: "jang-chaeyeon",          // 사진 이름 → images/members/jang-chaeyeon.jpg (없으면 .png, 그것도 없으면 이니셜)
  name: "Chaeyeon Jang",          // 영문 이름 — 카드 제목
  kor: "장채연",                  // 한글 이름 — 이름 옆 괄호 안에 표시
  role: "Undergraduate Researcher", // 과정 표기
  email: "",                      // 이메일 — 비우면("") 카드에 표시되지 않음
  interests: "",                  // 카드에 늘 보이는 연구 키워드 한 줄
