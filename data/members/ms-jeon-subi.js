...
MEMBER({
  ...
  slug: "jeon-subi",              // 사진 이름 → images/members/jeon-subi.jpg (없으면 .png, 그것도 없으면 이니셜)
  name: "Subi Jeon",              // 영문 이름 — 카드 제목
  kor: "전수비",                  // 한글 이름 — 이름 옆 괄호 안에 표시
  role: "M.S. Student",           // 과정 표기
  email: "jxxnsub@gmail.com",     // 이메일 — 비우면("") 카드에 표시되지 않음
  interests: "Flexible electronic devices (patch type), conductive masks", // 카드에 늘 보이는 연구 키워드 한 줄
