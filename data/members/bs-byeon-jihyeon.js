...
MEMBER({
  ...
  slug: "byeon-jihyeon",          // 사진 이름 → images/members/byeon-jihyeon.jpg (없으면 .png, 그것도 없으면 이니셜)
  name: "Jihyeon Byeon",          // 영문 이름 — 카드 제목
  kor: "변지현",                  // 한글 이름 — 이름 옆 괄호 안에 표시
