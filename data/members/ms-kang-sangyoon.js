...
MEMBER({
  ...
  slug: "kang-sangyoon",          // 사진 이름 → images/members/kang-sangyoon.jpg (없으면 .png, 그것도 없으면 이니셜)
  name: "Sangyoon Kang",          // 영문 이름 — 카드 제목
  kor: "강상윤",                  // 한글 이름 — 이름 옆 괄호 안에 표시
  role: "M.S. Student",           // 과정 표기
  email: "kanghan2000@naver.com", // 이메일 — 비우면("") 카드에 표시되지 않음
  interests: "Soft robotic gripper development, entrepreneurship activities", // 카드에 늘 보이는 연구 키워드 한 줄
